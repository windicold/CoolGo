...
import com.zzwq.coolgo.common.BmobManager;
import com.zzwq.coolgo.model.User;
import com.zzwq.coolgo.ui.activity.UserProfileActivity;
...
public class UserProfileFragment extends BaseFragment implements View.OnClickListener {
    ...
    private RelativeLayout mNickNameEtLayout;
    
    private EditText mUserNameEt;
    private Button mBtnUserName;
    private RelativeLayout mUsernameEtLayout;

    private RadioGroup mGenderRg;
    private RadioButton mGenderRbMan;
    private RadioButton mGenderRbFemale;
    private Button mBtnGender;
    private RelativeLayout mGenderEtLayout;
    ...
    private void initView(View view) {
        ...
        mNickNameEt = (EditText) view.findViewById(R.id.user_item_nickname_tv_edit);
        mBtnNickName = (Button) view.findViewById(R.id.user_btn_edit_confirm);
        mNickNameEtLayout = (RelativeLayout) view.findViewById(R.id.user_item_nickname_edit_layout);

        mUserNameEt = (EditText) view.findViewById(R.id.user_item_username_tv_edit);
        mBtnUserName = (Button) view.findViewById(R.id.user_item_username_tv_edit_btn);
        mUsernameEtLayout = (RelativeLayout) view.findViewById(R.id.user_item_username_edit_layout);

        mGenderRg = (RadioGroup) view.findViewById(R.id.user_item_gender_tv_radio_group);
        mGenderRbMan = (RadioButton) view.findViewById(R.id.user_item_gender_tv_radio_man);
        mGenderRbFemale = (RadioButton) view.findViewById(R.id.user_item_gender_tv_radio_female);
        mBtnGender = (Button) view.findViewById(R.id.user_item_gender_tv_edit_btn);
        mGenderEtLayout = (RelativeLayout) view.findViewById(R.id.user_item_gender_edit_layout);

        mTitleBarTvRight = (TextView) getActivity().findViewById(R.id.common_titleBar_tv_right);
        ...
        mNickNameEtLayout.setOnClickListener(this);

        mBtnUserName.setOnClickListener(this);
        mUsernameEtLayout.setOnClickListener(this);

        mBtnGender.setOnClickListener(this);
        mGenderEtLayout.setOnClickListener(this);


        mTitleBarTvRight.setOnClickListener(this);



        mAvatar.setImageURI(user.getHeadIcon().getUrl());
        mNameTvUsername.setText(user.getUsername());
        mNicknameTvNickname.setText(user.getNickname());
        mBindPhoneTvNickname.setText(user.getMobilePhoneNumber());
        mBindPhoneTvState.setText(R.string.user_item_right_modify);
        mLoginPasswordTvState.setText(R.string.user_item_right_modify);
        mGenderTvState.setText(user.getSex());
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.user_item_username_layout:
                mUsernameEtLayout.setVisibility(View.VISIBLE);
                mTitleBarTvRight.setText(R.string.user_item_right_modify);
                mTitleBarTvRight.setVisibility(View.VISIBLE);
                break;
            case R.id.user_item_username_tv_edit_btn:
                s = mUserNameEt.getEditableText().toString();
                mNameTvUsername.setText(s);
                newUser.setUsername(s);
                mUsernameEtLayout.setVisibility(View.GONE);
                break;
            case R.id.user_item_nickname_layout:
                mNickNameEtLayout.setVisibility(View.VISIBLE);
                mTitleBarTvRight.setText(R.string.user_item_right_modify);
                mTitleBarTvRight.setVisibility(View.VISIBLE);
                break;
            case R.id.user_btn_edit_confirm:
                s = mNickNameEt.getEditableText().toString();
                mNicknameTvNickname.setText(s);
                newUser.setNickname(s);
                mNickNameEtLayout.setVisibility(View.GONE);
                break;
            ...
            case R.id.user_item_gender_layout:
                mGenderEtLayout.setVisibility(View.VISIBLE);
                mTitleBarTvRight.setText(R.string.user_item_right_modify);
                mTitleBarTvRight.setVisibility(View.VISIBLE);
                break;
            case R.id.user_item_gender_tv_edit_btn:
                s = mGenderRg.getCheckedRadioButtonId() == R.id.user_item_gender_tv_radio_man ? "男" : "女" ;
                mGenderTvState.setText(s);
                newUser.setSex(s);
                mGenderEtLayout.setVisibility(View.GONE);
                break;
            ...
            case R.id.common_titleBar_tv_right:
                BmobManager.updateUserData(newUser,user);
                data = new Intent();
