...
import com.zzwq.coolgo.ui.activity.CartActivity;
import com.zzwq.coolgo.ui.activity.CollectActivity;
import com.zzwq.coolgo.ui.activity.CouponsActivity;
import com.zzwq.coolgo.ui.activity.HistoryActivity;
import com.zzwq.coolgo.ui.activity.LoginActivity;
import com.zzwq.coolgo.ui.activity.LotteryActivity;
import com.zzwq.coolgo.ui.activity.PaidActivity;
import com.zzwq.coolgo.ui.activity.TreasureActivity;
import com.zzwq.coolgo.ui.activity.UnpaidActivity;
...
//                openActivity(LoginActivity.class);
            ...
            case R.id.me_user_tv_cart:
                messageForNologin(CartActivity.class);

                break;
            case R.id.me_user_tv_favorite:
                messageForNologin(CollectActivity.class);

                break;
            case R.id.me_user_tv_history:
                messageForNologin(HistoryActivity.class);

                break;
            case R.id.me_item_unpaid_layout:
                messageForNologin(UnpaidActivity.class);

                break;
            case R.id.me_item_paid_order_layout:
                messageForNologin(PaidActivity.class);

                break;
            case R.id.me_item_lottery_layout:
                messageForNologin(LotteryActivity.class);

                break;
            case R.id.me_item_treasure_layout:
                messageForNologin(TreasureActivity.class);
                break;
    ...
    public void  messageForNologin(Class s){
